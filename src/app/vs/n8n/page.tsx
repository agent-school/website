      ...
      <main className="bg-white">
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto prose prose-slate">
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    <tr className="hover:bg-slate-50 transition">
                      ...
                      <td className="py-4 px-6 text-body-md text-slate-900">
            ...
            <h2 className="font-display text-display-md text-slate-900 mt-16 mb-8">
              Ease of Use
            </h2>
            ...
            <ul className="space-y-3 mb-12">
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">n8n:</strong> Great if you have a DevOps team available. Time to first workflow: 1-16 hours (depending on complexity and technical skill).
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Agent School:</strong> Designed for non-technical teams. Time to first agent: 30 minutes to 4 hours (no coding required).
              </li>
            </ul>
            ...
            <p className="text-body-lg text-slate-700 leading-relaxed mb-6">
              <strong className="text-slate-900">n8n excels at:</strong>
            </p>

            <ul className="space-y-3 mb-8">
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">IT Operations:</strong> User onboarding, provisioning, infrastructure monitoring
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">DevOps:</strong> CI/CD pipelines, deployment automation, incident response
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Data pipelines:</strong> ETL workflows, database syncing, API integrations
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Marketing automation:</strong> Social media posting, SEO tracking, content distribution (when you have dev support)
              </li>
            </ul>
            ...
            <ul className="space-y-3 mb-12">
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Hotel operations:</strong> Reservation management, occupancy tracking, rate updates across booking platforms
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Healthcare:</strong> Patient scheduling, insurance verification, claims processing (HIPAA-compliant)
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Financial services:</strong> Reconciliation, compliance reporting, transaction processing
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Customer support:</strong> Ticket routing, response drafting, escalation workflows
              </li>
            </ul>
            ...
            <p className="text-body-lg text-slate-700 leading-relaxed mb-8">
              <strong className="text-slate-900">n8n pricing for a mid-size company (50-500 employees):</strong>
            </p>

            <ul className="space-y-3 mb-8">
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Cloud:</strong> €50/month (~$660/year) for 10,000 executions, or enterprise pricing for unlimited
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Self-hosted:</strong> Free (open-source) + $60-240/year for infrastructure (VPS/cloud hosting)
              </li>
            </ul>
            ...
            <ul className="space-y-3 mb-8">
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Developer time to build workflows:</strong> $20K-40K/year (part-time DevOps resource at $80-120K salary)
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Ongoing maintenance:</strong> $10K-30K/year (fixing broken workflows, updating integrations, handling edge cases)
              </li>
              <li className="text-body-md text-slate-700 pl-4">
                <strong className="text-slate-900">Infrastructure management (self-hosted):</strong> $5K-15K/year (monitoring, updates, security patches)
              </li>
            </ul>

            <p className="text-body-lg text-slate-700 leading-relaxed mb-12">
              <strong className="text-slate-900">Total 3-year cost for n8n:</strong> $105K-255K (assuming part-time dev support + maintenance)
            </p>

            <p className="text-body-lg text-slate-700 leading-relaxed mb-8">
              <strong className="text-slate-900">Agent School pricing:</strong>
            </p>
            ...
            <div className="not-prose bg-orange-50 border border-orange-200 rounded-2xl p-8 mb-12">
              <p className="text-body-md text-slate-700 mb-4">
                <strong className="text-orange-700">The math:</strong> If you don't have a DevOps team available, n8n's "free" tier can end up costing $30K-80K/year in developer resources. Agent School eliminates that entirely by letting operations teams build and maintain agents themselves.
              </p>
