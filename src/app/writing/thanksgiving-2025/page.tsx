...
export const metadata = {
  title: "Thanksgiving 2025 | Jack Luo",
  description:
    "Gratitude notes from Thanksgiving — what Jack is thankful for this year, and why.",
};

const MEDIUM_URL =
  "https://thejackluo8.medium.com/thanksgiving-2025-c80951a30e10";

export default function Thanksgiving2025Page() {
  return (
    <>
      <Navbar />
            ...
            <div className="prose prose-slate max-w-none">
              <div className="space-y-6 text-slate-700 leading-relaxed">
                <p className="text-body-lg">
                  Thanksgiving is a good forcing function: sit down, and actually articulate what
                  you are grateful for. Not the vague ambient feeling, but the specific things.
                </p>

                <p className="text-body-md">
                  This is Jack&apos;s list from 2025 — the people, experiences, and moments that
                  made the year worth living.
                </p>
