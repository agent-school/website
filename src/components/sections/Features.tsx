          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              >
                ...
                <div
                  className={`w-8 h-5 rounded-full relative transition-colors ${guard.enabled ? "bg-orange-500" : "bg-slate-300"
                    }`}
                >
                  <div
                    ...
                    >
                      ...
                      {(DemoComponent || i === 4) && (
                        <button
                          ...
                          className="flex lg:hidden items-center gap-1.5 mt-6 text-sm font-semibold text-slate-900 hover:text-orange-600 transition-colors group"
                        >
                          {isExpanded
                    ...
                    {(DemoComponent || i === 4) && (
                      <div
                        className={`hidden lg:flex items-center justify-center p-8 ${
                          isExpanded
                            ? ""
                            : "bg-orange-50/50 cursor-pointer hover:bg-orange-100/50 transition-colors"
                        } ${!isEven ? "lg:order-1" : ""}`}
                        onClick={() => {
                          if (!isExpanded) {
                      ...
                      >
                        {isExpanded ? (
                          ...
                          <div className="w-full relative flex items-center justify-center">
                            <div className="w-full max-w-3xl relative">
                              <button
                                ...
                                className="absolute -top-4 -right-4 z-10 p-1.5 rounded-lg bg-white border border-slate-200 hover:bg-slate-100 transition-colors shadow-sm"
                          ...
                          <div className="w-full max-w-md text-center">
                            <div className="w-24 h-24 rounded-2xl bg-white border border-slate-200 shadow-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform">
