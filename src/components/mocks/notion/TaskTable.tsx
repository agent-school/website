      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-slate-200">
            ...
            <th className="px-3 py-2 text-left text-xs font-medium text-slate-600 w-32">
              Status
            </th>
            <th className="px-3 py-2 text-left text-xs font-medium text-slate-600 w-28">
              Priority
            </th>
            <th className="px-3 py-2 text-left text-xs font-medium text-slate-600 w-40">
              Assignee
            </th>
            <th className="px-3 py-2 text-left text-xs font-medium text-slate-600 w-32">
              Due Date
